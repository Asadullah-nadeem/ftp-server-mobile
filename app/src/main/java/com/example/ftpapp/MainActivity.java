...
public class MainActivity extends AppCompatActivity {
    ...
    LinearLayout mUserParent, mPasswdParent;
    Button mDirChooser;
    static String pass;
        ...
        if (ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.DYNAMIC_RECEIVER_NOT_EXPORTED_PERMISSION) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.DYNAMIC_RECEIVER_NOT_EXPORTED_PERMISSION)) {
                ...
                builder.setPositiveButton("OK", (dialog, id) -> {
                    dialog.dismiss();
                    justStarted = false;
                    ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.DYNAMIC_RECEIVER_NOT_EXPORTED_PERMISSION}, MY_PERMISSIONS_REQUEST);
                });
                builder.show();
            } else {
                ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.DYNAMIC_RECEIVER_NOT_EXPORTED_PERMISSION}, MY_PERMISSIONS_REQUEST);
